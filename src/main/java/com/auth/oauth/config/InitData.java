...
public class InitData {
    ...
    //@Bean
	/*
    ApplicationRunner applicationRunner(RegisteredClientRepository registeredClientRepository, UserDetailsManager userDetailsManager, RSAKeyRepository rsaKeyRepository) {
        return args -> {
